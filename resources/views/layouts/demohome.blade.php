        ...
        <div class="col-md-8">
            <div class="widget">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                 <div class="card">
                    <img src="{{ asset('image/products/'. 'helmet4.png')}}" class="card-img-top feature-img" alt="...">
                     <div class="card-body">
                ...
                <div class="col-md-4">
                 <div class="card">
                    <img src="{{ asset('image/products/'. 'helmet3.png')}}" class="card-img-top feature-img" alt="...">
                     <div class="card-body">
                           <h5 class="card-title">Helmet</h5>
                           <p class="card-text">Price: 2500 tk</p>
                           <a href="#" class="btn btn-primary">Add to cart</a>
                ...
                <div class="col-md-4">
                 <div class="card">
                    <img src="{{ asset('image/products/'. 'helmet5.png')}}" class="card-img-top feature-img" alt="...">
                     <div class="card-body">
                           <h5 class="card-title">Helmet</h5>
                           <p class="card-text">Price: 2500 tk</p>
                           <a href="#" class="btn btn-primary">Add to cart</a>
