...
<h2> My Cart Items </h2>
@if (App\Models\Models\Cart::totalItems() > 0)
    ...
    <tbody>
        ...
        <tr>
            ...
            @if ($cart->product->images->count() > 0)
                <img src="{{ asset('image/products/'.$cart->product->images->first()->image) }} " alt="" width = "80x">
            @endif
            </td>
            <td>
...
<div class = "float-right" align = "right">
    <a href="{{ route('homepage') }}" class = "btn btn-info btn-lg">Continue Shopping..</a>
